		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sample UI5",
									"targetURL": "#comexercisemyfirstsapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexercisemyfirstsapui5-display": {
								"semanticObject": "comexercisemyfirstsapui5",
								"action": "display",
								"description": "A Custom SAPUI5 application",
								"title": "Sample UI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.exercise.myfirstsapui5",
									"url": sap.ui.require.toUrl("com/exercise/myfirstsapui5")
								}
							}
						}
					}
